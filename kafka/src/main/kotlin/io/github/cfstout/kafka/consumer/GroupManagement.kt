 ...
 */
class GroupManagement<K, V>(topicPattern: Pattern,
    ...
    companion object {
        val logger = LoggerFactory.getLogger(GroupManagement::class.java)
    }
    ...
    // todo metrics
//    private val committed = metricFactory.meter("kafka_consumer.committed", standardMetricTags(consumerGroupName))
//    private val failedCommit = metricFactory.meter("kafka_consumer.failed_commit", standardMetricTags(consumerGroupName))
